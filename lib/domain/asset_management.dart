...
class CategoryIcons {
  static List<CategoryDataModel> mCategory = [
    ...
    CategoryDataModel(cId: 4, title: 'Public transport', icon: Assets.public_transport_image),
    CategoryDataModel(cId: 5, title: 'Music', icon: Assets.music_image),
    CategoryDataModel(cId: 6, title: 'Groceries', icon: Assets.groceries_image),
    CategoryDataModel(cId: 7, title: 'Gym', icon: Assets.gym_image),
    CategoryDataModel(cId: 8, title: 'Income', icon: Assets.income_image),
    CategoryDataModel(cId: 9, title: 'Fast food', icon: Assets.fast_food_image),
    CategoryDataModel(cId: 10, title: 'Laundry', icon: Assets.laundry_image),
    CategoryDataModel(cId: 11, title: 'Gift', icon: Assets.gift_image),
    CategoryDataModel(cId: 12, title: 'Drink', icon: Assets.drink_image),
    CategoryDataModel(cId: 13, title: 'Flight travel', icon: Assets.travel_image),
    CategoryDataModel(cId: 14, title: 'Movie', icon: Assets.movie_image),
    CategoryDataModel(cId: 15, title: 'Fruit', icon: Assets.fruite_image),
    CategoryDataModel(cId: 16, title: 'Massage', icon: Assets.massage_image),
    CategoryDataModel(cId: 17, title: 'Magazine', icon: Assets.magazine_image),
    CategoryDataModel(cId: 18, title: 'Books', icon: Assets.book_image),
    CategoryDataModel(cId: 19, title: 'Medicine', icon: Assets.medical_image),
    CategoryDataModel(cId: 20, title: 'Painting', icon: Assets.painting_image),
    CategoryDataModel(cId: 21, title: 'Salon', icon: Assets.salon_image),
    CategoryDataModel(cId: 22, title: 'Wallet', icon: Assets.wallet_image),
    CategoryDataModel(cId: 23, title: 'Food', icon: Assets.food_image),
    CategoryDataModel(cId: 24, title: 'Shopping', icon: Assets.shopping_cart_image),
    CategoryDataModel(cId: 25, title: 'Snack', icon: Assets.snack_image),
    CategoryDataModel(cId: 26, title: 'Investment', icon: Assets.income_image),
    CategoryDataModel(cId: 27, title: 'Insurance', icon: Assets.insurance_image),
    CategoryDataModel(cId: 28, title: 'Mortgage', icon: Assets.mortgage_image),
    CategoryDataModel(cId: 29, title: 'Toy', icon: Assets.toy_image),
    CategoryDataModel(cId: 30, title: 'Coffee', icon: Assets.coffee_image),
    CategoryDataModel(cId: 31, title: 'Electricity', icon: Assets.electricity_image),
    CategoryDataModel(cId: 32, title: 'Entertainment', icon: Assets.entertainment_image),
    CategoryDataModel(cId: 33, title: 'Room rent', icon: Assets.furniture_image),
    CategoryDataModel(cId: 34, title: 'Cigerettes', icon: Assets.cigerettes_image),
    CategoryDataModel(cId: 35, title: 'Parking', icon: Assets.parking_image),
    CategoryDataModel(cId: 36, title: 'Investment', icon: Assets.investment_imge)
  ];
}